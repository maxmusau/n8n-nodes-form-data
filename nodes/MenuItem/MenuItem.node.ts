	...
	description: INodeTypeDescription = {
		...
		properties: [
...

			{
				...
				default: 'MENU_ITEM',
				description: 'A menu item is simply an option in a menu',//. Its primary role is to indicate the
				// path that the user’s experience will follow
				required: true,
...

			{
				...
				default: '',
				placeholder: 'Menu Introduction Text} //or Please select an option',

				description: 'Text to display as menu item introduction',
				required: true,
